...
function selectedItems(){
	...
	for (i = 0; i < ele.length; i++) { 
		if (ele[i].checked) {
			para.appendChild(document.createTextNode(ele[i].value+" $"+products.find(el=>el.name === ele[i].value).price));
	...
	newPara.innerHTML = "Total Price is $" + getTotalPrice(chosenProducts)
